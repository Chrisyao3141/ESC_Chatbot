...
tokenized_train_data = tokenizer(train_data, truncation=True)#, max_length=tokenizer.model_max_length-100)
tokenized_validation_data = tokenizer(validation_data, truncation=True)#, max_length=tokenizer.model_max_length-100)
tokenized_test_data = tokenizer(test_data, truncation=True)#, max_length=tokenizer.model_max_length-100)
